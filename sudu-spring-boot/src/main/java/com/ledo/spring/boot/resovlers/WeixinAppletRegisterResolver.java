 ...
 */
public class WeixinAppletRegisterResolver extends ContextAbstractResolver {

    private JwtTokenProvider jwtTokenProvider;

    public WeixinAppletRegisterResolver(JwtTokenProvider jwtTokenProvider) {
        super(jwtTokenProvider);
    }

    @Override
    public boolean supportsParameter(MethodParameter methodParameter) {
        return methodParameter.hasParameterAnnotation(WeixinAppletRegisterContext.class);
    }

    @Override
    public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest nativeWebRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
        WeixinAppletRegisterContext annotation = methodParameter.getParameterAnnotation(WeixinAppletRegisterContext.class);
        //获取要绑定的值
